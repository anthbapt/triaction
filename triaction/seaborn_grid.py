...
class SeabornFig2Grid:
    ...
    Args:
        ...
        fig (matplotlib.figure.Figure): The Matplotlib figure to contain the Seaborn grid.
        subplot_spec (matplotlib.gridspec.SubplotSpec):
            The subplot specification defining the position and size of the grid.

    Attributes:
        fig (matplotlib.figure.Figure): The Matplotlib figure containing the Seaborn grid.
    ...
    def _moveaxes(self, ax, gs):
        ...
        Args:
            ax (matplotlib.axes.Axes): The Matplotlib axes to be moved and resized.
            gs (matplotlib.gridspec.GridSpec): The grid specification defining the position and size.
        """
